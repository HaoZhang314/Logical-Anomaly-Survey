...
| **Mamba-LAD**: Unsupervised Logical Anomaly Detection in Industry via Mamba with Nested Pyramid Fusion | Neurocomputing | 2026 | Mamba (SSM) backbone with nested pyramid fusion and parameter-shared state space enhancement; captures long-range sequential dependencies to model global logical constraints | [[paper](https://doi.org/10.1016/j.neucom.2026.132824)] |
| **HMSI**: Heterogeneous Multi-Score Integration for Structural and Logical Anomaly Detection | IEEE Access | 2026 | Integrates heterogeneous scoring signals from multiple complementary AD models; ensemble fusion consistently improves both structural and logical anomaly AUROC | [[paper](https://doi.org/10.1109/ACCESS.2026.3687139)] |
| **PC-Reg**: Modeling Spatial Dependencies for Training-Free Anomaly Detection | SSRN | 2026 | Training-free spatial dependency modeling between image regions via probabilistic consistency; captures positional regularity violations characteristic of logical anomalies | [[paper](https://doi.org/10.2139/ssrn.6592369)] |
...
| **Slot-Scene-Graph**: Slot-Consistent Scene Graphs for Unsupervised Anomaly Detection in Grid-Structured Industrial Images | ETAI | 2026 | Builds slot-consistent scene graphs over regularly arranged components in grid-layout industrial images; graph consistency verification detects missing, extra, or swapped components | [[paper](https://doi.org/10.1109/ETAI68332.2026.11485187)] |
| **RelSim-LAD**: Logical Anomaly Detection Based on Relative Similarity Analysis of Region Segments | IWAIT | 2026 | Detects logical anomalies by computing relative similarity between corresponding region segments of test and reference images; reference-guided verification of positional and compositional constraints | [[paper](https://doi.org/10.1117/12.3102400)] |
...
| **Fastener-AD**: Fastener Anomaly Detection for Industrial Assembly via Few-Shot Fine-Grained Component Segmentation | Neurocomputing | 2025 | Few-shot fine-grained component segmentation tailored for fastener anomaly detection; count, type, and position violations identified via component-level matching | [[paper](https://doi.org/10.1016/j.neucom.2025.131432)] |
